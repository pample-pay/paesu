    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('business_name', models.CharField(max_length=33, null=True, unique=True, verbose_name='사업자상호')),
                ('business_add', models.CharField(max_length=33, null=True, unique=True, verbose_name='\x08사업자주소')),
                ('business_regnum', models.CharField(max_length=33, null=True, unique=True, verbose_name='사업자등록번호')),
                ('region', models.CharField(choices=[('0', '군포')], max_length=18, verbose_name='지역')),
